...
export const REACTIONS: ReactionRule[] = [...CARBONYL_REACTIONS, ...SUBSTITUTION_REACTIONS, ...ALKENE_REACTIONS, ...AROMATIC_REACTIONS, ...ELECTROCHEMISTRY_REACTIONS, ...INORGANIC_REACTIONS];
